...
const Menuu1 = () => {
  return (
    <div className="menuu w-full h-auto bg-[#191919] text-white">
      <div className="overlay px-[1.5rem] sm:px-[2rem] xl:px-[4rem] pt-[50px]">
        ...
        <div className="xl:w-full w-[380px] sm:w-[580px] grid xl:grid-cols-2 grid-cols-1 xl:px-8 p-[10px] xl:py-8 bg-[#191919] gap-[20px] xl:gap-[15px]">
          {MenuData.map((coffee) => (
            <div key={coffee.id}>
              <Menuu2 {...coffee} />
            </div>
